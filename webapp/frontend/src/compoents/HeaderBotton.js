    ...
    return(
        <div className="header-inner-bottom">
            ...
            <div className="header-bottom-right">
                ...
                <button className="menu-btn" onClick={() => setMapType("BASE")}>기본지도</button>
                <button className="menu-btn" onClick={() => setMapType("HYBRID")}>항공사진</button>
